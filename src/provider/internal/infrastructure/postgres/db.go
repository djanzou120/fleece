// Package postgres gere le pool de connexions PostgreSQL du service provider.
//
...
//
// TODO(driver): ajouter l'import du driver concret dans src/provider/main.go
...
// Le parametre searchPath est injecte via SET search_path dans la DSN si non vide.
