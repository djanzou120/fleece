...
//
// L'interface Broker est definie en couche 3 (internal/adapters/webhook).
...
// Assertion de conformite a la compilation : NoopBroker doit implementer webhook.Broker.
// Couche 4 → couche 3 : sens autorise (vers l'interieur).
var _ webhook.Broker = (*NoopBroker)(nil)
...
//
// TODO(amqp): creer AMQPBroker qui implemente webhook.Broker avec amqp091.
type NoopBroker struct{}

// NewNoopBroker retourne un NoopBroker (satisfait webhook.Broker).
