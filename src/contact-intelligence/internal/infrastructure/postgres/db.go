// Package postgres gere le pool de connexions PostgreSQL du service contact-intelligence.
//
...
//
// TODO(driver): ajouter l'import du driver concret dans src/contact-intelligence/main.go
...
// Le parametre searchPath est injecte dans la DSN.
