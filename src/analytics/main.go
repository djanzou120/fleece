// Command analytics est le point d'entree (composition root) du analytics Service.
//
...
func main() {
	app.Bootstrap("analytics")
	// TODO: charger la config, ouvrir Postgres (schema "analytics"), connecter
