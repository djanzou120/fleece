...
> **Créé le :** 2026-07-14
> **Statut global :** ✅ Phase 0 · ✅ Phase 1 · ✅ Phase 2 · ✅ Phase 3 (PASS) · 🔵 Phase 4 partielle (M-024 ✅ · M-025 ✅ · D-M40 CRUD ✅ · **M-023 ⛔ EN ATTENTE DU FEU VERT UTILISATEUR**) — branche `migration/phase-3`
> **Bloquants avant Phase 5 :** (1) feu vert explicite pour M-023 (suppression irréversible de 8 services Go + branche `wip/T-018-campaign`) ; (2) **D-M43** — le volet **livraison** des webhooks sortants (HMAC + dispatcher + retry) n'est toujours pas porté ; T-005 échouerait en QA de régression, et M-023 supprimerait son code de référence.
