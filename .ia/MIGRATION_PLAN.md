...
> **Créé le :** 2026-07-14
> **Statut global :** ✅ Phase 0 · ✅ Phase 1 · ✅ Phase 2 · ✅ Phase 3 (PASS) · 🔵 Phase 4 partielle (M-024 ✅ · M-025 ✅ · D-M40 CRUD ✅ · **D-M43 livraison ✅** · D-M44 ✅ · **M-023 ⛔ EN ATTENTE DU FEU VERT UTILISATEUR**) — branche `migration/phase-3`
> **Bloquants avant Phase 5 :** (1) feu vert explicite pour M-023 (suppression irréversible de 8 services Go + branche `wip/T-018-campaign`). **D-M43 n'est plus bloquant** : le volet livraison (HMAC + dispatcher + scheduler de retry) est porté dans `core-processor`, T-005 est de nouveau couvert de bout en bout, et M-023 ne fait plus perdre de code de référence.
